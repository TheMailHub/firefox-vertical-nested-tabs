...
Nested (tree) tabs for Firefox's **native vertical tabs**. Nothing changes while tabs are horizontal. For Tree Style Tab fans who want to use Firefox's native vertical implementation. 
